...
public class ChatDAO extends UnicastRemoteObject implements ChatDAOInterface {
    ...
    public int createGroup(String creatorPhone, List<String> participantPhones, String groupName,byte[] image) {
        int chatId = -1;
    ...
    private boolean checkIn(int userId, int chatID) {
        String query = "select * from UserChat where chatID = ? and userID = ?;";
    ...
    private UserDTO findGroup(int chatId) throws RemoteException {
