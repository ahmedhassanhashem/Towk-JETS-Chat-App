...
public class ContactDAO {
    ...
    public boolean acceptContactRequest(String receiverPhone, String senderPhone) {
    ...
    public boolean rejectContactRequest(String receiverPhone, String senderPhone) {
        String getIdQuery = "SELECT id FROM UserContact " +
                            "WHERE receiverID = (SELECT userID FROM User WHERE phone = ?) " +
                            "AND senderID = (SELECT userID FROM User WHERE phone = ?) " +
                            "AND requestStatus = 'PENDING'";
    ...
    public boolean deleteRejectedContact(String receiverPhone, String senderPhone) {
        String getIdQuery = "SELECT id FROM UserContact " +
                            "WHERE receiverID = (SELECT userID FROM User WHERE phone = ?) " +
                            "AND senderID = (SELECT userID FROM User WHERE phone = ?) " +
